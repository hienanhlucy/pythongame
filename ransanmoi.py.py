...
blue = (50, 153, 213)
pink = (255, 192, 203)
colors = [black, green, yellow, red, pink]

dis_width = 500
dis_height = 400
dis = pygame.display.set_mode((dis_width, dis_height))
pygame.display.set_caption('Welcome Ran San Moi')
...
def our_snake(snake_block, snake_list):
    for segment in snake_list:
        pygame.draw.rect(dis, segment[2],
...
def gameLoop():
    ...
    while not game_over:
        ...
        snake_Head = [x1, y1, colors[current_color_index]]
    ...
    dis.fill(white)
    message("May thua roi luon di", red)
    show_score(score)
    pygame.display.update()
    time.sleep(2)
